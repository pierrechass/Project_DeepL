...
We will in a second time compare the two numbers to see which one is the biggest. Same as Test 3 but ADD SOME BATCH NORM AND DROPOUT !
"""

# Useful for dropout : https://machinelearningmastery.com/dropout-for-regularizing-deep-neural-networks/
...
[train_input, train_target, train_classes, test_input, test_target, test_classes]=  prologue.generate_pair_sets(N)
    ...
    # Dropout2d with p=0.1
    # eta=1e-2
    # optimizer: SGD
    # nb_hidden : 200
    # score  :  8.79    testing set classes    
    #           6.06    testing set target
    #           7.33    training set classe
    #           4.81    training set target
    #
    ...
    # optimizer: SGD
    # nb_hidden : 200
    # score  :  8.5   testing set classes    
    #           5.77    testing set target
    #           7.00    training set classe
    #           4.96    training set target
    #
    # criterion : nn.crossEntropyLoss()
    ...
    # optimizer: Adam
    # nb_hidden : 200
    # score  :  7.09   testing set classes    
    #           5.03   testing set target
    #           2.725    training set classe
    #           2.09    training set target
    #
    # criterion : nn.crossEntropyLoss()
