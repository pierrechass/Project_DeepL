...
for k in range(10):
    model = ResNet(nb_residual_blocks = 3, nb_channels = 16,
                   kernel_size = 3, nb_classes = 2,
    ...
    train_model(model, train_input, train_target, mini_batch_size)      # small residual blocks give bad result for training and testing 
